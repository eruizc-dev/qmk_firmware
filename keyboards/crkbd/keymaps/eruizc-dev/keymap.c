...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUMBER] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_LT, KC_LBRC, KC_LCBR, KC_LPRN, KC_MINUS,    KC_PLUS, KC_RPRN, KC_RCBR, KC_RBRC, KC_GT, KC_BSLS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_UNDS,   KC_EQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
